...
<template>
    <section class="box skills">
      <div class="stack gap-2 lg:gap-4">
        ...
        <h2>Du Dev à la prod</h2>
        <p>j'adore Laravel, Adonis et Django et part dessus tout j'aime suivre les projet jusqu'à la production</p>
      </div>
      <div class="stack gap-2 lg:gap-4">
        <Icon icon="trophy" color="var(--accent-regular)" size="2.5rem" gradient />
        <h2>Team Player</h2>
        <p>j'ai une asaince a travailler en equipe.</p>
      </div>
      <div class="stack gap-2 lg:gap-4">
        <Icon icon="strategy" color="var(--accent-regular)" size="2.5rem" gradient />
        <h2>Touche à tout</h2>
        <p>j'aime toujours apprendre et toucher tout ce qui me parrait interressant.</p>
      </div>
    </section>
  </template>
