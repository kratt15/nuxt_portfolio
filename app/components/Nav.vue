...
<template>
    <nav>
      ...
      <ul class="nav-items" :class="{ 'menu-content': true }" :hidden="!isMenuExpanded">
      ...
      <div class="menu-footer" :class="{ 'menu-content': true }" :hidden="!isMenuExpanded">
        <div class="socials">
          <a 
  ...
  const iconLinks: { label: string; href: string; icon: keyof typeof iconPaths }[] = [
    ...
    { label: 'GitHub', href: 'https://github.com/kratt15', icon: 'github-logo' },
  ...
  const handleViewports = (e: MediaQueryList | MediaQueryListEvent) => {
    isMenuExpanded.value = e.matches
    if (menuButton.value) {
      menuButton.value.hidden = e.matches
    }
  }
