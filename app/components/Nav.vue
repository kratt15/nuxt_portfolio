...
<template>
  <nav>
    ...
    <!-- Support no-JS (visible par défaut) -->
    <!-- <ul class="nav-items" :class="{ 'menu-content': isJsEnabled }">
    ...
    <!-- <div class="menu-footer" :class="{ 'menu-content': isJsEnabled }">
      <div class="socials">
        <a
    ...
    <!-- Menu mobile avec JS -->
    <div id="menu-content" :hidden="!isMenuExpanded" class="menu-content">
      <ul class="nav-items">
        <li v-for="link in textLinks" :key="link.href">
          <NuxtLink
            :to="link.href"
